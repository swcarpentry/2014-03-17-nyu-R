...
##Draw diagram on the board connecting the local workflow with the remote workflow. Add key words and arrows as we continue.

__take a 5 minute break and have everyone write down their git names so they can be added to the repo__
...
`git commit -m "adding new file to-learn.md"`
